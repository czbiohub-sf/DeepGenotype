...
def parse_args():
    ...
    parser.add_argument('--fastq_R1_suffix', default="_R1_001.fastq.gz", type=str, help='(optional) suffix to add to sample ID to map to fastq files [default = _R1_001.fastq.gz]', metavar='')
    parser.add_argument('--fastq_R2_suffix', default="_R2_001.fastq.gz", type=str, help='(optional) suffix to add to sample ID to map to fastq files [default = _R2_001.fastq.gz]', metavar='')
